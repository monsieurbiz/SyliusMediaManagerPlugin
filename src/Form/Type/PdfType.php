...
final class PdfType extends AbstractType
{
    public function __construct(
        #[Autowire(param: 'monsieurbiz_sylius_media_manager.max_file_size.pdf')]
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setDefault('file_type', FileInterface::TYPE_PDF);
        $resolver->setDefault('max_file_size', $this->maxFileSize);
        $resolver->setDefault('folder', 'gallery/pdfs'); // Keep empty the use `/public/media` as root.
    }
