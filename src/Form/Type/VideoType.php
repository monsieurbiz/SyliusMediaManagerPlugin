...
final class VideoType extends AbstractType
{
    public function __construct(
        #[Autowire(param: 'monsieurbiz_sylius_media_manager.max_file_size.video')]
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->setDefault('file_type', FileInterface::TYPE_VIDEO);
        $resolver->setDefault('max_file_size', $this->maxFileSize);
        $resolver->setDefault('folder', 'gallery/videos'); // Keep empty the use `/public/media` as root.
    }
